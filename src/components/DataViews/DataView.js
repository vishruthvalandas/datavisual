    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4">
          <div
            class="card"
            style={{ backgroundColor: Color("#D9D9D9").alpha(0.2).string() }}
          >
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <div class="col-sm-12">
                    <div
                      class="card"
                      style={{
                        backgroundColor: Color("#D9D9D9").alpha(0.2).string(),
                        marginBottom:"30px"
                      }}
                    >
                      <div class="card-body" onClick={()=>{navigate("/dataview")}}>
                        <p class="card-text">
                          <div class="col">
                ...
                <div class="col-sm-12">
                  <div
                    class="card"
                    style={{
                      backgroundColor: Color("#cccccc").alpha(0.1).string(),
                    }}
                  >
                    <div class="card-body" onClick={()=>{navigate("/dataview")}}>
                      <p class="card-text">
        ...
        <div class="col-sm-8">
          <div
            class="card"
            style={{ backgroundColor: Color("#cccccc").alpha(0.2).string() }}
          >
            <div class="card-body">
              <div class="row">
